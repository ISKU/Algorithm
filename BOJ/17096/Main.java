...
public class Main {
	...
	private static List<Edge>[] graph = new ArrayList[500001];
	private static long[] dist = new long[500001];
	private static long[] prev = new long[500001];
	...
	public static void solve() {
		...
		while (!pq.isEmpty()) {
			...
			for (Edge v : graph[u.vertex]) {
				...
				t += v.weight - prev[v.vertex];
				prev[v.vertex] = v.weight;
			}
		}
	...
	public static void main(String[] args) {
		io = new FastIO(System.in, System.out, 1 << 24, 1 << 4);
		solve();
		io.close();
	}
