...
public class C {
	...
	private static char[][] pattern = new char[][] { { 'R', 'G', 'B' }, { 'R', 'B', 'G' }, { 'G', 'R', 'B' },
			{ 'G', 'B', 'R' }, { 'B', 'R', 'G' }, { 'B', 'G', 'R' } };

	private static void solve() {
		int N = io.nextInt();
		char[] garland = io.nextToCharArray();
	...
	private static class FastIO {
		...
		public static final int DEFAULT_LINE_SIZE = 200000;
